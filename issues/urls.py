...
from issues.views import IssuesListView, CreateIssueView, UpdateIssueView,DeleteIssueView
...
urlpatterns = [
    ...
    path('issue/<int:pk>/delete/', DeleteIssueView.as_view(), name='issue_delete'),
